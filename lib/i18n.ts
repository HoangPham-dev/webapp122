...
const translations = {
    en: {
        ...
        signInToSaveActionSignIn: 'Sign in',
        signInToSaveOr: ' or ',
        signInToSaveActionCreate: 'create an account',
        signInToSaveSuffix: ' to save this invoice.',
    ...
    vi: {
        ...
        previewInvoice: 'Xem trước hoá đơn',
        ...
        signInToSaveActionSignIn: 'Đăng nhập',
        signInToSaveOr: ' hoặc ',
        signInToSaveActionCreate: 'tạo tài khoản',
        signInToSaveSuffix: ' để lưu hóa đơn này.',
    ...
    nl: {
        ...
        previewInvoice: 'Factuurvoorbeeld',
        ...
        signInToSaveActionSignIn: 'Meld u aan',
        signInToSaveOr: ' of ',
        signInToSaveActionCreate: 'maak een account',
        signInToSaveSuffix: ' om deze factuur op te slaan.',
